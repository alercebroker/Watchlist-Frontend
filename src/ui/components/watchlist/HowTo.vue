  ...
  <v-container>
    <v-card class="mx-auto">
      ...
      <v-list-item>
        <v-list-item-content>
          <v-list-item-title
            >1. The header must be: name, ra, dec and radius, all in lower
            case.</v-list-item-title
          >
        </v-list-item-content>
      </v-list-item>
      ...
      <v-list-item>
        <v-list-item-content>
          <v-list-item-title
            >3. The values of the fields can be separated by the following
      ...
      <v-list-item>
        <v-list-item-content>
          <v-list-item-title
            >4. The table below shows the fields and the accepted
      ...
      <v-list-item>
        <v-list-item-content>
          <v-list-item-title
            ><b
              >7. You can see the example below with a CSV format using comma
              separation.</b
            ></v-list-item-title
          >
        </v-list-item-content>
