...
describe("Watchlist actions", () => {
    describe("EditWatchlist", () => {
        it("should update specific watchlist if response is ok", async () => {
          ...
          expect(
            modules.modules.singleWatchlist.mutations[MutationTypes.SET_NOTIFICATION_RATE]
          ).toHaveBeenCalled();
          expect(
            modules.modules.singleWatchlist.mutations[MutationTypes.SET_TITLE]
          ).toHaveBeenCalled();
          expect(
            modules.modules.watchlists.mutations[WatchlistMutationTypes.UPDATE_WATCHLIST]
          ).toHaveBeenCalled();
        });
